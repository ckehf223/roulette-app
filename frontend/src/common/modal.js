  ...
  function (e, t, n) {
    ...
    var u = (function () {
      ...
      g = {
        ...
        header: '<div class="card-header is-horizontal"></div>',
        headerClose:
          '<button class="button test is-close is-ghost" data-dismiss="modal" aria-label="Close">' +
            '<span class="icon is-close is-dark-gray is-large" aria-hidden="true">' +
            '<svg><use href="#close"></use></svg></span></button>',
        body: '<div class="card-body"></div>',
        footer: '<div class="card-footer"></div>',
        backdrop: '<div class="modal-background"></div>',
      },
      k = (function (e) {
        function t() {
          var e =
              ...
              value: function () {
                ...
                return (
                  this.el.classList.contains(t.animateClass) &&
                    (t.animate = !0),
                  (e.container = this.el),
                  (e.dialog = this.el.querySelector(".card")),
                  (e.content = this.el.querySelector(".card-body")),
                  (e.header = this.el.querySelector(".card-header")),
                  (e.headerClose = this.el.querySelector(
                    ".card-header .is-close",
                  )),
                  (e.body = this.el.querySelector(".card-body")),
                  (e.footer = this.el.querySelector(".card-footer")),
                  this._setHeader(),
                  this._setContent(),
                  this._setFooter(),
                  this
            ...
            },
            {
              ...
              value: function (e) {
                if(e.which === 27 && this._options.keyboard){
                  ...
                  if(this.el === element){
                    this.emit("dismiss",e,null),this.hide();
                  }
                }
              },
            },
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  (n.container.style.display = "flex"),
            ...
            },
            {
              ...
              value: function () {
                ...
                (t.backdrop = d(n.backdrop)),
                  ...
                  t.container.prepend(t.backdrop),
